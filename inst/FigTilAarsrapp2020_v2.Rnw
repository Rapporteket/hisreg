...
RegData_ny <- allevar[, c("MCEID", "AGE_ABSCESS", "UtdanningSSB", "SURGERY", "MEDICATION_HISTORY_HS",
                          ...
                          "PREDNISOLON", "ISOTRETINOIN", "METFORMIN", "ANTIINFLAMMATORY_TREATMENT_OTHER")]
...
varname <- c('BMI', "DLQISUM", "VASSCORE")
gr_var <- 'SykehusNavn'
...
varnameGjSnittPrePost <- c('DLQI_PrePost_ny', 'Vas_PrePost_ny')
gr_var <- 'SykehusNavn'
