...
# Les inn data
RegData <- read.table('I:/hisreg/AlleVarNum2018-05-02 10-01-10.txt', header=TRUE, sep=";", encoding = 'UFT-8')
RegData <- RegData[, c('m_mceid', 'p_age_abscess', 'p_education', 'p_surgery', 'p_antibiotics', 'pre_smoking', 'pre_work', 'pre_bmi', 'pre_dlqisum',
                       ...
                       "i_corticosteroid_injection", "i_acelacic_acid", "i_clindamycin", "i_resorcinol",
                                  "i_medical_other")]
Followups <- read.table('I:/hisreg/FollowupsNum2018-05-02 10-01-12.txt', header=TRUE, sep=";", encoding = 'UFT-8')
...
ForlopsData <- read.table('I:/hisreg/ForlopsOversikt2018-05-02 10-01-12.txt', header=TRUE, sep=";", encoding = 'UFT-8')
