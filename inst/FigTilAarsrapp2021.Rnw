...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{SATISFACTION.pdf}
\caption{Pasienttilfredshet}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{RETREATMENT.pdf}
\caption{Ville du takket ja til samme behandling på nytt?}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{RECOMMENDATION.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{IMPOSSIBLE_REASON.pdf}
