...
\title{Figurer og tabeller for årsrapport Hisreg 2016}
\author{Hisreg}
...
# Les inn data
RegData <- read.table('P:/MinData/hisreg/AlleVarNum2017-09-01 10-30-34.txt', header=TRUE, sep=";", encoding = 'UFT-8')
RegData <- RegData[, c('m_mceid', 'p_age_abscess', 'p_education', 'p_surgery', 'p_antibiotics', 'pre_smoking', 'pre_work', 'pre_bmi', 'pre_dlqisum',
                       ...
                       "i_corticosteroid_injection", "i_acelacic_acid", "i_clindamycin", "i_resorcinol",
                                  "i_medical_other")]
Followups <- read.table('P:/MinData/hisreg/FollowupsNum2017-09-01 10-30-36.txt', header=TRUE, sep=";", encoding = 'UFT-8')
...
ForlopsData <- read.table('P:/MinData/hisreg/ForlopsOversikt2017-09-01 10-30-36.txt', header=TRUE, sep=";", encoding = 'UFT-8')
...
\caption{Registrerende avdelinger i Hisreg 2016.}
\end{figure}
...
\caption{Kjønnsfordeling i Hisreg 2016.}
\end{figure}
