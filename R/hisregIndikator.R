...
#' @param indikatordata En dataramme med kolonnene SykehusNavn, Aar og Variabel
#'
#' @export
#'

hisregIndikator <- function(indikatordata, tittel='', terskel=5, minstekrav = NA, maal = NA, skriftStr=1.3, pktStr=1.4,
...
{
  # indikatordata <- indikator1; tittel='testtittel'; terskel=30; minstekrav = NA; maal = 50; skriftStr=1.3; pktStr=1.4;
  # legPlass='top'; minstekravTxt='Min.'; maalTxt='Mål'; graaUt=NA; decreasing=F; outfile = '';
  # lavDG=NA; width=800; height=700; inkl_konf=F; maalretn='hoy'
  ...
  AntTilfeller <- tidyr::spread(Tabell[, -c(4,5)], 'Aar', 'Antall', fill=0)
  ...
  N <- tidyr::spread(Tabell[, -c(3,5)], 'Aar', 'N', fill=0)
