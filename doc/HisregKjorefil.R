...
# Les inn data
RegData <- read.table('C:/SVN/jasper/hisreg/data/AlleVarNum2017-01-23 11-06-17.txt', header=TRUE, sep=";", encoding = 'UFT-8')
...
ForlopsData <- read.table('C:/SVN/jasper/hisreg/data/ForlopsOversikt2017-01-23 11-06-18.txt', header=TRUE, sep=";", encoding = 'UFT-8')
